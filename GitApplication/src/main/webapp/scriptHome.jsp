...
<body>
	<div class="jumbotron text-center"
		...
		<h1 style="position: relative; right: 80px; bottom: 30px">Preference
			Finder</h1>
	...
	<div class="row justify-content-center">
		<div class="col-sm-4" style="position: relative; right: 70px;">
			<form action="ScriptSearchServlet" method="POST"
				onsubmit="return myFunction()">
				<div class="form-group">
					<label for="repoNamelabel"><b>Repository Name</b></label> <input
						type="text" class="form-control" name="scriptRepoName"
						id="scriptRepoName" aria-describedby="repoNameHelp"
				...
				<div class="form-group">
					<label for="keywordlabel"><b>Keyword</b></label> <input type="text"
						class="form-control" name="scriptKeyword" id="scriptKeyword"
	...
	<script>
		function myFunction() {
			var keyword = document.getElementById("scriptKeyword").value;
			if (keyword === '') {
