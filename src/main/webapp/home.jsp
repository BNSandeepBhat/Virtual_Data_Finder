...
<body>
	...
	<div class="jumbotron text-center" style="background: #0d94d2">
		<img src="images/Cerner.png" height="180" width="200"
			class="rounded float-left" alt="..."
			style="position: relative; left: 10px; bottom: 70px;" />
		<h1 style="position: relative; right: 80px;">Virtual Data Finder</h1>
	</div>
